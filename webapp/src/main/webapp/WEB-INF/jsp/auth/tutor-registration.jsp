...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-auto card mx-2">
            <div class="card-body">
                <div class="row">
                    <%--@elvariable id="form" type="by.bsuir.webapp.dto.TutorRegistrationDto"--%>
                    <form:form action="/tutor-registration"
                               method="post" modelAttribute="form" cssClass="mt-md-3">
                        <div class="form-group">
                            <form:label path="value" cssClass="form-label">Номер телефона</form:label>
                            <form:errors path="value" cssClass="text-danger" />
                            <form:input path="value" type="number" cssClass="form-control" value=""/>
                        </div>
                        <div class="form-group">
                            <form:label path="duration" cssClass="form-label">Длительность (мин)</form:label>
                            <form:errors path="duration" cssClass="text-danger" />
                            <form:input path="duration" type="number" cssClass="form-control" value=""/>
                        </div>
                        <div class="form-group">
                            <form:label path="rate" cssClass="form-label">Стоимость (руб/час)</form:label>
                            <form:errors path="rate" cssClass="text-danger" />
                            <form:input path="rate" type="number" cssClass="form-control" value=""/>
                        </div>
                        <div class="form-group">
                            ...
                            <form:select path="type" cssClass="form-control">
                                <c:forEach items="${typeList}" var="type">
                                    <option value="${type.getOrder()}">${type.getName()}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                        <div class="form-group">
